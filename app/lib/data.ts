...
export const FAQS = [
  ...
  {
    q: "إزاي أدفع؟",
    a: "فودافون كاش أو إنستا باي، أو كاش في الفرع. إحنا مابنستقبلش دفع بالفيزا أو أي كارت على الموقع، ومابنطلبش منك بيانات بنكية خالص — بتحوّل أو بتدفع في الفرع والعضوية بتتفعّل بعد التأكيد.",
  },
  {
...
/**
 * طرق الدفع المتاحة — **مفيش دفع بالفيزا/الكروت خالص**.
 * الموقع ما بيستقبلش ولا بيخزن ولا بيمرّر أي بيانات بطاقات، والاشتراك بيتفعّل
 * بعد ما الإدارة تأكد استلام الفلوس من اللوحة.
 */
export const PAY_METHODS = [
  { id: "wallet", label: "فودافون كاش / إنستا باي", hint: "تحويل على محفظة الجيم" },
  { id: "cash", label: "كاش في الجيم", hint: "مكانك محجوز 48 ساعة" },
] as const;

export type PayMethodId = (typeof PAY_METHODS)[number]["id"];

/** أرقام تحويل الجيم (بتتعرض في خطوة الدفع) */
export const PAY_TARGETS = [
  { name: "فودافون كاش", value: "01000000000" },
  { name: "إنستا باي", value: "fitzone@instapay" },
] as const;
